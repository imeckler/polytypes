...
Elm.Interactive = Elm.Interactive || {};
Elm.Interactive.make = function (_elm) {
   "use strict";
   _elm.Interactive = _elm.Interactive || {};
   if (_elm.Interactive.values)
   ...
   var render = function () {
      var constantStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                              ...
                                                              ,{ctor: "_Tuple2"
                                                               ,_0: "backgroundColor"
                                                               ,_1: "#009CFF"}]));
      var topStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                          ,_0: "width"
                                                          ,_1: "100%"}
                                                         ,{ctor: "_Tuple2"
                                                          ,_0: "height"
                                                          ,_1: "100%"}]));
      var coveredCss = _L.fromArray([{ctor: "_Tuple2"
                                     ,_0: "backgroundColor"
                                     ,_1: "#333"}
                                    ,{ctor: "_Tuple2"
                                     ,_0: "width"
      ...
      var prodCss = _L.fromArray([{ctor: "_Tuple2"
                                 ...
                                 ,{ctor: "_Tuple2"
                                  ,_0: "height"
                                  ,_1: "50%"}]);
      var prodStyle = $Html$Attributes.style(prodCss);
      var sumCss = _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "width"
                                 ,_1: "50%"}
                                ,{ctor: "_Tuple2"
                                 ,_0: "height"
   ...
   _v18) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var d = A2($Basics._op["++"],
                 $Basics.toString(A2($Basics.min,
                 _v18._0,
                 _v18._1)),
                 "px");
                 var css = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                ,_0: "width"
                                                                ,_1: d}
                                                               ,{ctor: "_Tuple2"
                                                                ,_0: "height"
   ...
   var RightOpen = F2(function (a,
   b) {
      return {ctor: "RightOpen"
             ,_0: a
             ,_1: b};
   });
   var LeftOpen = F2(function (a,
   b) {
      return {ctor: "LeftOpen"
             ,_0: a
             ,_1: b};
   });
   var $switch = F2(function (p,
   m) {
      return function () {
   ...
   var state = function (m0) {
      return $Signal.map($Debug.watch("Model"))(A3($Signal.foldp,
      update,
      m0,
      A2($Signal.map,
      $Debug.watch("Update"),
         ...
         var go = function (q) {
            return function () {
               ...
               {case "Add":
                  ...
                  case "Const":
                  return Constant(q._0);
                  case "Mul": return A2(Join,
                    go(q._0),
                    go(q._1));
